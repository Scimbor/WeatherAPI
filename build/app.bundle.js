...
var API_KEY = '11555b105c0aeb052b12cf451e30cdea';
...
var UI = function () {
    ...
    _createClass(UI, [{
        key: 'showWeather',
        value: function showWeather(data) {
        ...
        value: function showChart(data) {
            ...
            for (var _i = 0; _i < 7; _i++) {
                arrayTemp.push(data.list[_i].main.temp);
                arrayPress.push(data.list[_i].main.pressure);
            }
